...
export const mbtiResults: Record<string, MbtiResult> = {
  ESTJ: {
    ...
    subtitle: '"규칙이 곧 수익이다"',
    description:
      "당신은 철저한 매매 원칙을 세우고 감정 없이 실행하는 기계형 투자자입니다. 손절선 도달하면 눈물 없이 칼손절, 목표가 도달하면 미련 없이 익절. 주변에서 '냉혈한'이라고 부르지만 사실 당신이 제일 오래 살아남습니다. 종토방에서 '흔들리지 마세요'라고 댓글 달아주는 그 사람이 바로 당신.",
  ...
  ESTP: {
    ...
    description:
      "당신은 순간의 기회를 놓치지 않는 타고난 단타 트레이더입니다. 아침 9시 개장벨이 울리면 심장이 두근거리고, 호가창을 보면 눈이 반짝입니다. 점심도 주식 보면서 먹고, 화장실도 폰 들고 갑니다. 하루에 10번 매매는 기본. 수수료가 수익보다 많아도 '오늘은 연습이었어'라고 합리화하는 당신.",
  ...
  ENTJ: {
    ...
    description:
      "당신은 주식을 단순한 투자가 아닌 사업으로 접근하는 전략가입니다. 섹터 배분, 리밸런싱, 헤지 전략까지 완벽하게 관리합니다. 주변 사람들한테 투자 강의를 자청하고, 카카오톡 프로필에 '투자 철학'을 적어놓는 타입. 수익률보다 '프로세스'를 더 중요시합니다.",
  ...
  ENTP: {
    ...
    description:
      "당신은 남들이 모르는 숨겨진 테마주를 발굴하는 것에 희열을 느끼는 탐험가 투자자입니다. AI, 2차전지, 우주, 로봇... 새로운 테마가 뜨면 가장 먼저 달려갑니다. 종토방에서 '이 종목 아직 모르는 사람?'으로 시작하는 글을 자주 씁니다. 10개 중 1개만 맞아도 된다는 마인드.",
  ...
  ESFJ: {
    ...
    description:
      "당신은 주식 커뮤니티의 핵심 인물입니다. 보유 종목 게시판에서 '화이팅!' 댓글을 달아주고, 손실 중인 사람들을 위로해줍니다. 종목 선택도 커뮤니티 분위기에 영향을 많이 받습니다. '다들 좋다고 하니까 좋겠지'라는 생각으로 매수하는 경우가 많습니다. 혼자 수익 내는 것보다 같이 수익 내는 게 더 좋은 사람.",
  ...
  ESFP: {
    ...
    description:
      "당신은 주식 유튜버, 인플루언서, 오픈채팅방의 핫한 종목 정보를 따라가는 트렌디한 투자자입니다. 구독자 100만 유튜버가 추천하면 일단 매수. 나중에 알고 보면 그 유튜버가 이미 팔고 나간 경우가 많지만... 그래도 다음 영상도 열심히 봅니다. 주식보다 주식 콘텐츠 보는 시간이 더 긴 타입.",
  ...
  ENFJ: {
    ...
    description:
      "당신은 주변 모든 사람에게 주식 투자를 권유하는 열정적인 전도사입니다. 부모님, 친구, 심지어 처음 만난 사람에게도 '지금 안 하면 후회해요'라고 말합니다. 본인도 수익률이 좋지 않을 때도 있지만, 투자 자체의 중요성을 전파하는 것에 사명감을 느낍니다. 주변 사람이 손실 나면 본인 일처럼 마음 아파합니다.",
  ...
  ENFP: {
    ...
    description:
      "당신은 무한한 낙관주의로 무장한 희망 투자자입니다. 지금 -50%여도 '이건 분명히 오른다'는 확신이 있습니다. 재무제표보다 '이 회사의 비전'을 더 중요하게 봅니다. 투자 일기를 쓰고, 종목에 애착을 갖습니다. 손절을 '포기'라고 생각하기 때문에 좀처럼 손절을 못합니다. 하지만 가끔 진짜 10배 종목을 발굴하기도 합니다.",
  ...
  ISTJ: {
    ...
    description:
      "당신은 대한민국 국민주 삼성전자, 코스피 ETF, 미국 S&P500 ETF를 묵묵히 적립식으로 매수하는 안정형 투자자입니다. 단기 변동에 흔들리지 않고, 10년, 20년을 바라봅니다. 주변에서 '재미없다'고 해도 '수익률이 재미다'라고 말합니다. 실제로 장기적으로는 대부분의 단타 트레이더보다 수익률이 좋습니다.",
  ...
  ISTP: {
    ...
    description:
      "당신은 캔들 차트, 이동평균선, RSI, MACD를 보며 매매 타이밍을 잡는 기술적 분석의 달인입니다. 뉴스나 소문보다 차트를 더 신뢰합니다. 혼자 조용히 분석하고, 조용히 매매합니다. 종토방에는 거의 안 가고, 차트 분석 결과만 가끔 공유합니다. 말은 없지만 수익률은 있습니다.",
  ...
  INTJ: {
    ...
    subtitle: '"데이터만이 진실이다"',
    description:
      "당신은 감정이 아닌 데이터와 알고리즘으로 투자하는 냉철한 분석가입니다. PER, PBR, ROE 같은 지표를 엑셀로 정리하고, 백테스팅을 돌려봅니다. 파이썬으로 자동매매 시스템을 만들려고 시도한 적이 있습니다. 주변에서 '너무 복잡하게 생각한다'고 하지만 당신은 '단순한 게 위험하다'고 생각합니다.",
  ...
  INTP: {
    ...
    description:
      "당신은 주식 투자보다 경제 이론과 거시경제 분석에 더 관심이 많은 학구파 투자자입니다. 워런 버핏 전기를 3번 읽었고, 레이 달리오의 유튜브는 다 봤습니다. 투자 아이디어는 넘치는데 실제 매매는 잘 안 합니다. '아직 더 분석이 필요해'라는 말을 입에 달고 삽니다. 결국 분석하다가 기회를 놓치는 경우가 많습니다.",
  ...
  ISFJ: {
    ...
    description:
      "당신은 화려한 시세차익보다 꾸준한 배당금을 선호하는 안정 지향 투자자입니다. 배당수익률 5% 이상 종목만 매수하고, 배당락일 전후 주가 변동에 일희일비하지 않습니다. 매달 배당금이 들어올 때마다 스크린샷 찍어서 저장합니다. '주식으로 월급 받는 느낌'을 좋아합니다.",
  ...
  ISFP: {
    ...
    description:
      "당신은 재무제표보다 '이 회사가 좋은 일을 하는가'를 더 중요하게 생각하는 가치 중심 투자자입니다. 환경, 사회적 가치, 좋아하는 브랜드에 투자합니다. 손실이 나도 '좋은 회사니까 괜찮아'라고 생각합니다. 주식 앱보다 그 회사의 제품을 더 자주 씁니다. ESG 투자의 선구자.",
  ...
  INFJ: {
    ...
    description:
      "당신은 워런 버핏과 찰리 멍거를 롤모델로 삼는 진지한 가치투자자입니다. 단기 변동은 노이즈일 뿐이라고 생각하고, 기업의 본질적 가치에 집중합니다. 주식 투자를 '기업의 일부를 소유하는 것'으로 정의합니다. 주변에서 '너무 진지하다'고 하지만 당신은 '투자는 진지해야 한다'고 믿습니다.",
  ...
  INFP: {
    ...
    description:
      "당신은 현실보다 희망을 믿는 낭만적 투자자입니다. 물린 종목에 대해 '이건 분명히 반등한다'는 믿음을 버리지 못합니다. 주식 투자 일기를 쓰고, 종목에 이름을 붙여줍니다. '삼성이', '카카오야' 이런 식으로요. 손절은 배신이라고 생각합니다. 하지만 그 믿음 덕분에 가끔 진짜 대박이 나기도 합니다.",
